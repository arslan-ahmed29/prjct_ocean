...
const STATIC_WARNINGS: Warning[] = [
  {
    ...
    description: 'Rip currents active near Johnnie Mercer\'s Pier. If caught, swim parallel to shore — do not fight the current.',
    source: 'static',
    timestamp: Date.now(),
  },
  {
    id: 'static-stinger-1',
    severity: 'advisory',
    title: 'Sea Nettles in Surf Zone',
    description: 'Sea nettle jellyfish reported in the surf near Banks Channel. Wear water shoes and keep children aware.',
    source: 'static',
    timestamp: Date.now(),
  },
]
